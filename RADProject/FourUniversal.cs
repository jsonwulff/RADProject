    ...
    public class FourUniversal : Hash{
        ...
        public FourUniversal(int img, bool random) : base(img, random){
            ...
            if (random){
                ...
                Byte[] c_bytes = {0x67, 0x95, 0x10, 0xe6, 0xfb, 0xe8, 0x1c, 0x49, 0x7b, 0x3d, 0xa1, 0x00};
                Byte[] d_bytes = {0xa1, 0x6a, 0x75, 0xb9, 0x84, 0x49, 0x56, 0x5a, 0x93, 0xb0, 0x63, 0x00};
        ...
        public void hashgen() {
            ...
            Byte[] a_bytes, b_bytes, c_bytes, d_bytes = new Byte[12];
            ...
            a_bytes[11], b_bytes[11], c_bytes[11], d_bytes[11] = 0x00;
        ...
        public override Tuple<ulong, int> hash(ulong x){
